                ...
                <div class="skio-group-content">
                  <div class="skio-custom-content">
                    <div class="skio-container">
                      ...
                      <div>${ (this.price(group.selected_selling_plan, false) / 100).toFixed(0) == '0' || (this.price(group.selected_selling_plan, false) / 100).toFixed(0) == '9' ? '1 Month Supply' : 'Refills for $' + (this.price(group.selected_selling_plan, false) / 100).toFixed(0) + '/refill' }</div>
                    </div>
