...
export class SkioPlanPickerComponent extends LitElement {
            ...
            <div class="skio-group-container skio-group-container--available ${ this.selectedSellingPlanGroup == group ? 'skio-group-container--selected' : '' }" skio-group-container
              ...
              <label skio-label-subscription class="skio-group-label" for="skio-selling-plan-group-${ index }-${ this.key }">
                <div class="skio-group-topline">
                  ...
                  <div class="skio-center-wrapper">
                    <div class="skio-group-title">
                    <p> ${this.discount(group.selected_selling_plan).amount}</p>
                    <p> ${(this.price(group.selected_selling_plan, false) / 100).toFixed(0) }</p>
                    ${ group.name == 'Subscription' ?  this.discount(group.selected_selling_plan).percent == '0%' ? 'Free Trial Special' : 'Subscribe & Save' : group.name }
                    ...
                    <div class="skio-price skio-subscribe-price">
  ...
  updated = (changed) => {
    ...
    if(changed.has('selectedSellingPlan')) {
      console.log('selling plan changed')
