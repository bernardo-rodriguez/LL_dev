                  ...
                  <div class="bundle-container">
                    <div class="bundle-option" data-bundle="1">
                      <div class="bundle-content">
                        <input type="radio" name="onetime_bundle" value="1" data-custom-price="${ this.oneTimePricingConfig['first']['subtotal'] }">
                    ...
                    <div class="bundle-option" data-bundle="2">
                      ...
                      <div class="bundle-content">
                        <input type="radio" name="onetime_bundle" value="2" data-custom-price="${ this.oneTimePricingConfig['second']['subtotal'] }" checked>
                        <div class="bundle-details">
                          <div class="bundle-header">
                            <div>
                    ...
                    <div class="bundle-option" data-bundle="3">
                      ...
                      <div class="bundle-content">
                        <input type="radio" name="onetime_bundle" value="3" data-custom-price="${ this.oneTimePricingConfig['second']['subtotal'] }" >
                        <div class="bundle-details">
                          <div class="bundle-header">
                            <div>
              ...
              <label skio-label-subscription class="skio-group-label" for="skio-selling-plan-group-${ index }-${ this.key }">
                <div class="skio-group-topline">
                  ...
                  <div class="skio-center-wrapper">
                    ...
                    ${ group.name == 'Subscription' ?  (this.price(group.selected_selling_plan, false) / 100).toFixed(0) == '0' ? 'Free Trial Special' : 'Subscribe & Save' : group.name }
                ...
                <div class="skio-group-content">
                  <div class="skio-custom-content">
                    <div class="skio-container">
                      ...
                      <div>${ (this.price(group.selected_selling_plan, false) / 100).toFixed(0) == '0' || (this.price(group.selected_selling_plan, false) / 100).toFixed(0) == '9' ? '1 Month Supply' : 'Refills for $' + (this.price(group.selected_selling_plan, false) / 100).toFixed(0) + '/delivery' }</div>
                    </div>
